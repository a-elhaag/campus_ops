        ...
        <main className="min-h-screen p-4 md:p-8 space-y-8 max-w-7xl mx-auto pt-8">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <form action="/api/auth/logout" method="POST" className="inline">
                        <button type="submit" className="text-sm font-medium text-gray-500 hover:text-gray-900 underline underline-offset-4">
                            Logout
                        </button>
                    </form>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-3xl font-bold">{event._count.rsvps}{event.capacity ? ` / ${event.capacity}` : ''}</div>
                    </CardContent>
                </Card>
                <Card>
                    <CardHeader className="pb-2">
            ...
            {role === 'admin' && (
                <div className="pt-8 border-t border-gray-200 mt-8">
                    <h2 className="text-xl font-bold text-gray-900 mb-4">Event Settings (Admin Only)</h2>
